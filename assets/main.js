...
async function renderShop() {
  ...
  if (!wrap) return; // not on shop page

  // products.json is next to /assets/ relative to root pages
...
// PWA register (use relative path so it works on root & /products/)
...
// Kick off (safe to run on any page)
renderShop();
